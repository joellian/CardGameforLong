...
/**
 *  An object of type com.example.cardgameforlong.Deck represents a deck of playing cards.  The deck
...
public class Deck {
     ...
     * randomize the order.  (Note that "new com.example.cardgameforlong.Deck()" is equivalent
     * to "new com.example.cardgameforlong.Deck(false)".)
     */
    public Deck() {
...
} // end class com.example.cardgameforlong.Deck
